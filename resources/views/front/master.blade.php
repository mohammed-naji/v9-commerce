            ...
            <div class="row">
                <div class="col-md-4 col-xs-12 col-sm-4">
                    <div class="contact-number">
                        ...
                        {{-- <a href="mailto:moh@gmail.com">Send</a> --}}
                    </div>
                </div>
                <div class="col-md-4 col-xs-12 col-sm-4">
                    <!-- Site Logo -->
                ...
                <div class="col-md-4 col-xs-12 col-sm-4">
                    ...
                    <ul class="top-menu text-right list-inline">
                        ...
                        @else
                            <li class="dropdown">
                                <a href="{{ route('login') }}"><i class="tf-ion-user"></i>Login</a>
                            </li>
                        @endif
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse text-center">
                    <ul class="nav navbar-nav">
                        ...
                        {{-- https://github.com/mohammed-naji/v9-commerce --}}
                                            </ul>
                                        </div>
                                    @endforeach
					...
					<li class="dropdown dropdown-slide">
						...
						<ul class="dropdown-menu">
                            @foreach (Category::all() as $category)
                                <li><a href="{{ route('site.category', $category->id) }}">{{ $category->name_en }}</a></li>
                            @endforeach

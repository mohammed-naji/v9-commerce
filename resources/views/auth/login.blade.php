                        ...
                        <div class="authfy-panel panel-login text-center active">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <form name="loginForm" class="loginForm" action="{{ route('login') }}" method="POST" autocomplete="off">
                                        @csrf

                                        <div class="form-group">
                                            <input id="email" type="email" class="form-control mb-0 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"  autocomplete="email" autofocus>
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            <div class="pwdMask">
                                                <input id="password" type="password" class="form-control mb-0 password @error('password') is-invalid @enderror" name="password" autocomplete="new-password">
                                        ...
                                        <div class="form-group">
                                            <button
                                                class="btn btn-lg btn-primary btn-block">Login with
                                                email</button>
